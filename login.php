...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('build/img/'); ?>icon-posyandu-1.png">
        ...
        <section class="login_content">
            <form class="user validate-form" action="<?php echo base_url('login'); ?>" method="POST">
                ...
                <div class="separator">
                    ...
                    <div>
                        <h1><img style="width: 29px; height: 29px; border-radius: 50%; margin-right: 10px" src="<?= base_url('build/img/'); ?>icon-posyandu-1.png" alt=""></i>RS Melati Husada </h1>
                        <span> RS Ibu dan Anak Melati Husada </span>
                    </div>
                </div>
            </form>
        </section>
